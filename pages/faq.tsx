    ...
    <Layout>
      <div className={styles.faq}>
        ...
        <div className={styles.faq__item}>
          ...
          <p>
          Mu::ses is a collection of 300 unique melodies, generated by AI <a href="https://www.aiva.ai/" rel="noreferrer"  target="_blank" >(using AIVA)</a>, serialized in text format, and stored on the Polygon blockchain.
          </p>
        </div>
